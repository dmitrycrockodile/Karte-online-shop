<template>
    ...
    <main v-if="!isLoading">
                    ...
                    <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
                        <div class="single-product-box one">
                            <swiper 
                                ...
                                :modules="modules"
                                :navigation="{ nextEl: '.mainNextArrow', prevEl: '.mainPrevArrow'}"
                            ...
                            >
                                ...
                                <div v-if="product.old_price !== null" class="ptag"> 
                                    <span class="one">{{ this.countDiscountPercentage(product.old_price, product.price) }}</span> 
                                </div> 
                                ...
                                <button class="slider-arrow mainPrevArrow" aria-disabled="false">
                                    <i class="flaticon-left-arrow-1"></i>
                                </button>
                                <button class="slider-arrow mainNextArrow" aria-disabled="false">
                                    <i class="flaticon-next-1"></i>
                                </button>
                            </swiper>
                            <div v-if="!product.product_images.length" class="big-product single-product-one">
                                <div class="single-item">
                                ...
                                <div class="shop-details-top-color-sky-box">
                                    ...
                                    <ul class="varients">
                                        <li v-for="color in product.colors"> 
                                            <button :title="color.title" class="shop-details-top-color-sky-img" :style="`background-color: ${color.title}`"</button> 
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="product-quantity-box d-flex align-items-center flex-wrap">
                                        <div class="qty mr-2">
                                            <div class="qtySelector text-center"> 
                                                ...
                                                <input type="number" class="qtyValue" v-model="selectedQuantity" /> 
                                ...
                                <ul class="shop-details-top-category-tags">
                                    ...
                                    <li>Tags: 
                                        <span v-for="(tag, i) in product.tags">
                                            {{(i + 1 === product.tags.length) ? tag.title : `${tag.title}, &nbsp;` }}
                                        </span>
                                    </li>
                                </ul>
        ...
        <section class="recent-products pt-60 pb-120 overflow-hidden wow fadeInUp">
            <div class="container ">
                <div :id="`popup${popupId}`" class="product-gird__quick-view-popup mfp-hide">
                    <div v-if="popupProduct" class="container">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-lg-6">
                                <div v-if="!popupProduct.product_images.length" class="popup-product-single-image">
                                    <img :src="popupProduct.preview_image"
                            ...
                            <div class="col-lg-6">
                                <div class="popup-right-content">
                                    ...
                                    <div class="price">
                                        <h2> ${{ popupProduct.price }} <del v-if="!!popupProduct.old_price"> ${{ popupProduct.old_price }} USD</del></h2>
                                        <h6>{{ popupProduct.count > 0 ? "In stuck" : "Out of stuck" }} </h6>
                                    </div>
                                    <div class="color-varient"> 
                                      <a v-for="color in popupProduct.colors" :style="`background: ${color.title};`" href="#0" class="color-name">
                ...
                <div class="row mt-30 wow fadeInUp animated">
                    <swiper 
                        ...
                        :slides-per-view="4"
                        :modules="modules"
                        :navigation="{ nextEl: '.recentNextArrow', prevEl: '.recentPrevArrow'}"
                        class="catagory-slider"
                    >
                        <swiper-slide v-for="product in recentProducts" class="products-grid-one">
                            <div class="products-grid-one__product-image">
                                ...
                                <div class="products-grid__usefull-links">
                                    <ul>
                                        ...
                                        <li>
                                            <a @click="getPopupProduct(product.id)" :href="`#popup${popupId}`" class="popup_link"> 
