                  ...
                  <div class="tab-content" id="pills-tabContent-two">
                      <div class="tab-pane fade show active" id="pills-best-sellers" role="tabpanel"
                          ...
                          <swiper 
                            ...
                            :modules="modules"
                            >
                              <swiper-slide class="products-three__inner">
                              ...
                              <li class="products-three-single wow fadeInUp animated">
                                  <div class="products-three-single-img img-bg">
                                      <a href="shop-details-3.html" class="d-block">
                                          ...
                                          <div class="products-grid-one__badge-box"> <span
                                                  class="bg_black badge discount">-10%</span> 
                                          </div> 
                                       </a>
                                                  <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                          <div class="products-grid__usefull-links">
              ...
              <div class="row wow fadeInUp mt-30 animated">
                  <div class="col-xl-12">
                      <swiper 
                        ...
                        :modules="modules"
                        >
                          <swiper-slide class="product-slider__single text-center">
                              <div
      ...
      <div class="gallery-two wow fadeInUp animated overflow-hidden">
          <div class="container-fluid">
              <div class="row">
                  <div class="col-xl-12">
                      <swiper 
                        class="gallery-two__slider mb-5 pb-5"
                        :slides-per-view="6"
                        :pagination="{ clickable: true }"
                        :modules="modules" 
                        :autoplay="{
                        ...
                        > 
                            <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img1.jpg"
                                class="gallery-two__single"> <img src="../../assets/images/home-three/gallery-v2-img1.jpg"
                                    alt="" /> <span class="zoom-icon"> <i class="flaticon-expand"></i> </span> 
                            </a> </swiper-slide>
                            <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img2.jpg" class="gallery-two__single"> <img
                                    src="../../assets/images/home-three/gallery-v2-img2.jpg" alt="" /> <span
                                    class="zoom-icon"> <i class="flaticon-expand"></i> </span> 
                            </a> </swiper-slide>
                                    <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img3.jpg" class="gallery-two__single"> <img
                                    src="../../assets/images/home-three/gallery-v2-img3.jpg" alt="" /> <span
                                    class="zoom-icon"> <i class="flaticon-expand"></i> </span> 
                            </a> </swiper-slide>
                                    <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img4.jpg" class="gallery-two__single"> <img
                                    src="../../assets/images/home-three/gallery-v2-img4.jpg" alt="" /> <span
                                    class="zoom-icon"> <i class="flaticon-expand"></i> </span> 
                            </a> </swiper-slide>
                                    <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img5.jpg" class="gallery-two__single"> <img
                                    src="../../assets/images/home-three/gallery-v2-img5.jpg" alt="" /> <span
                                    class="zoom-icon"> <i class="flaticon-expand"></i> </span> 
                            </a> </swiper-slide>
                                    <swiper-slide><a href="../../assets/images/home-three/gallery-v2-img6.jpg" class="gallery-two__single"> <img
