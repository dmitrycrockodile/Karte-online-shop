<template>
   <div>
      ...
      <header class="header-style-3">
                                       ...
                                       <div class=" d-flex align-items-center justify-content-between ">
                                             ...
                                             <div class="right d-flex align-items-center justify-content-end">
                                                <ul class="main-menu__widge-box d-flex align-items-center ">
                                                   ...
                                                   <li class="cartm"> 
                                                      <button @click.prevent="setIsModalActive(true)" class="number cart-icon"> 
                                                         <i class="flaticon-shopping-cart"></i>
         ...
         <CartSideMenu :active="isCartModalActive" @setActive="setIsModalActive" />
      ...
      <button :class="scrollButtonClasses" class="scrollToTop wow" @click="scrollToTop"><i class="flaticon-up-arrow"></i></button>
      <!--===scroll bottom to top===-->
   </div>
</template>
...
<script>
   ...
   export default {
      ...
      methods: {
         ...
         setIsModalActive(bool) {
            this.isCartModalActive = bool
         }
      },
   }
</script>
